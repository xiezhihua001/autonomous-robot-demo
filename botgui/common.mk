...
ROOT_PATH    := $(subst /botgui/common.mk,,$(realpath $(lastword $(MAKEFILE_LIST))))
SRC_PATH     := $(ROOT_PATH)/botgui/.
BIN_PATH     := $(ROOT_PATH)/bin/.
LIB_PATH     := $(ROOT_PATH)/botgui/lib/.
JAVA_PATH    := $(ROOT_PATH)/java/.
LCMTYPES_PATH:= $(ROOT_PATH)/lcmtypes/.
...
# lcm
CFLAGS_LCM  := -I `pkg-config --cflags lcm`
LDFLAGS_LCM := -L `pkg-config --libs lcm`
...
# lcmtypes
CFLAGS_LCMTYPES  := -I$(LCMTYPES_PATH) $(CFLAGS_LCM)
LDFLAGS_LCMTYPES := -L -llcmtypes -L$(LIB_PATH) $(LDFLAGS_LCM)
